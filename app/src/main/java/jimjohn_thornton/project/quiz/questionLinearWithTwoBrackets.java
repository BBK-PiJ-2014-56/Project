 ...
 */
public class questionLinearWithTwoBrackets {
    Random generator = new Random();
    private int coeff1 = generator.nextInt(5) + 1;
    private int coeff2 = generator.nextInt(5) + 1;
    private int coeff3 = generator.nextInt(5) + 1;
    private int coeff4 = generator.nextInt(5) + 1;
    private int c = generator.nextInt(10) - 4;
    private int d = generator.nextInt(10) - 4;
    ...
    public question getQuestion() {
        ...
        String qString = "Solve for x \n" + coeff2 + "(" + coeff1 + "x + " + c + ") = " + coeff3 + "(" + coeff4 + "x + " + ((coeff2*((coeff1*a1) + c)) - (coeff3 * coeff4 * a1 )) + ")";
