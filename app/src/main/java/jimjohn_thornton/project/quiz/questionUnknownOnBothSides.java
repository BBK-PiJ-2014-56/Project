 ...
 */
public class questionUnknownOnBothSides {

    Random generator = new Random();
    private int coeff1 = generator.nextInt(10) - 4;
    private int coeff2 = generator.nextInt(10) - 4;
    ...
    public question getQuestion() {
        ...
        String qString = "Solve for x \n" + coeff1 + "x + " + c + " = " + coeff2 + "x + " + ((a1*(coeff1-coeff2))+c);
